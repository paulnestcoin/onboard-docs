...
The Onboard Protocol network is mainly comprised of three types of users: _liquidity providers_, _customers_, and _developers_, all of whom interact with the SCEA.
...
Developers integrate with Onboard Protocol's smart contracts to create innovative trading interfaces and retail experiences. The open-source nature of Onboard allows for a variety of applications covering several [use cases](/use-cases/overview).
