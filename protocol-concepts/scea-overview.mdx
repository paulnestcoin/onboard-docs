...
- **Storage of assets:** store assets not locked in an ongoing transaction, similar an [externally-owned account](https://www.quicknode.com/guides/ethereum-development/getting-started/what-are-ethereum-accounts).
