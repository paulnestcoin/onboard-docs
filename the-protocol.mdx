...
The core innovation enabling the protocol is a [Smart Contract Escrow Account](/protocol-concepts/scea-overview), which securely locks assets during a trade, and only releases these assets after the explicit approval of both buyer and seller, or in cases of disputes, a mediator.
